...
> Good start, Phillip. A couple of tweaks to the functional requirements are needed
...
> In the functionality list, you should probably mention the creation of individual accounts, keep individual data secure via logins, etc.
